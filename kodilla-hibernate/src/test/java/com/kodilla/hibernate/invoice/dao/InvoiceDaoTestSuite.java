...
class InvoiceDaoTestSuite {
    ...
    void testInvoiceDaoSave() {
        //Given
        Invoice invoice = new Invoice("715");

        Product product1 = new Product("Product 1");

        Item item1 = new Item(new BigDecimal(PRICE), 1);
        Item item2 = new Item(new BigDecimal(PRICE), 2);
        Item item3 = new Item(new BigDecimal(PRICE), 4);
